      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-card border border-card-border rounded-xl p-6">
          ...
          <p className="text-accent-cyan text-sm">
            {metrics.tvlChange > 0 ? '+' : ''}{metrics.tvlChange}% monitored active
          </p>
        </div>
        ...
        <div className="bg-card border border-card-border rounded-xl p-6">
          ...
          <p className="text-accent-cyan text-sm">
            {metrics.volumeChange > 0 ? '+' : ''}{metrics.volumeChange}% from last hour
          </p>
        </div>
      </div>
        ...
        <div className="bg-card border border-card-border rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-text-secondary text-sm">Protocol growth monitoring</p>
            </div>
            <div className="flex gap-2">
              <button className="px-3 py-1 text-xs bg-card border border-card-border rounded hover:bg-zinc-800 transition">1W</button>
              <button className="px-3 py-1 text-xs bg-accent-cyan/10 border border-accent-cyan rounded text-accent-cyan">1M</button>
            </div>
          </div>
        ...
        <div className="bg-card border border-card-border rounded-xl p-6">
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-text-secondary text-sm">Risk assessment tracking</p>
            </div>
            <div className="flex gap-2">
              <button className="px-3 py-1 text-xs bg-card border border-card-border rounded hover:bg-zinc-800 transition">1W</button>
              <button className="px-3 py-1 text-xs bg-accent-cyan/10 border border-accent-cyan rounded text-accent-cyan">1M</button>
