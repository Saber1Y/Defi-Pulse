      ...
      <main className="mx-auto max-w-7xl px-4 py-6">
        ...
        <footer className="mt-16 flex flex-col md:flex-row items-center justify-between text-text-tertiary text-xs py-8 border-t border-card-border">
          <div className="flex items-center gap-2">
            ...
            <span>© 2024 Somnia Testnet Integration - Ready Only Dashboard</span>
          </div>
          <div className="flex gap-6 mt-4 md:mt-0">
            <a href="#" className="hover:text-foreground transition">Alert Config</a>
            <a href="#" className="hover:text-foreground transition">API Feed</a>
            <a href="#" className="hover:text-foreground transition">Security Docs</a>
          </div>
        </footer>
      </main>
    </div>
